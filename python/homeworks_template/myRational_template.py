...
myPi(n)方法：計算總和並印出結果，請留意輸出格式，當只有1項, 2項, 3項, 及4項以上的輸出都是評分的項目。
...
myPi(0)=3, 逼近值為:3.0
myPi(1)=19/6, 逼近值為:3.1666666666666665
myPi(2)=47/15, 逼近值為:3.1333333333333333
...
myPi(1500)=(要能正確顯示完整的分數), 逼近值為:3.1415926535158674
